...
""" contain the fields from user_data.csv that are considered PII. """


class RedactingFormatter(logging.Formatter):
    """ Redac Formatter class
        """
...
def filter_datum(fields: List[str],
                 ...
                 message: str,
                 separator: str) -> str:
    """ func that returns the log message obfuscated """
    for item in fields:
...
def get_logger() -> logging.Logger:
    """ func that returns a logging.Logger object """
